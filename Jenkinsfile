pipeline {
    ...
    environment {
        ...
        NEXUS_URL = "ec2-35-154-111-243.ap-south-1.compute.amazonaws.com:8081"
        ...
        stage('deploy'){
            steps{
                 withCredentials([usernameColonPassword(credentialsId: 'tomcat_credentails', variable: 'tomcat_credentails')]) {
                  sh "curl -v -u ${tomcat_credentails} -T result.war 'http://ec2-35-154-212-2.ap-south-1.compute.amazonaws.com:8080/manager/text/deploy?path=/nexusdeploy3&update=true'"
